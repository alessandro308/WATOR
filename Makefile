...
# terzo frammento 
FILE_DA_CONSEGNARE3=collector.c dispatcher.c gestione_segnali.c valutazione_argomenti.c valutazione_argomenti.h visualizer.c wator_main_thread.c wator_thread_funzioni.c wator_thread_funzioni.h wator.c wator.h watorscript worker.c relazione.pdf wator.conf
