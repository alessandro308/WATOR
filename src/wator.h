/**
   ...
   \brief Dichiarazione di funzioni e di variabili globali e non relative alla libreria di supporto
*/ 
#ifndef __WATOR__H
#define __WATOR__H
#define CIFRE_MAX 10
...
#include <pthread.h>
#include <signal.h>
/*Dichiarazioni per l'implementazione multithread*/
extern pthread_mutex_t set_critica;
extern int** skip;
extern int** critica;
extern struct sigaction sa;
extern pthread_mutex_t set_skip;
extern unsigned int seed;

/** file di configurazione */
static const char CONFIGURATION_FILE[] = "wator.conf";
extern pthread_mutex_t accesso_dumpfile;
...
/** Regola 1: gli squali mangiano e si spostano 
  ...
  NECESSITA DI SRAND GIà SEMINATO
...
/*Questa funzione è l'equivalente della funzione update_wator in cui è implementata la gestione multithread*/
/*Usa una matrice skip condivisa tra i thread, acceduta in mutex, che gestisce eventuali conflitti*/
